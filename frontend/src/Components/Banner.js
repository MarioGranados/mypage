            ...
            <div className="container py-4">
                <div className="p-5 mb-4 bg-light rounded-3">
                    <div className="container-fluid py-5">
                        <h1 className="display-5 fw-bold">Keep it simple, one link is all you need</h1>
                        <p className="col-md-8 fs-4">Connect all your social media accounts with one link</p>
                        <button className="btn btn-primary btn-lg" type="button">Claim Your Page</button>
                    </div>
                </div>
